...
// Exported so surfaces that already supply their own bubble can render the raw
// icon image directly, without nesting a second StickerIcon bubble inside
// theirs. Nesting two bubbles squished the icon: the inner fixed-size bubble
// was wider than the outer one's padded content box, so as a flex child it
// collapsed on the main axis into an oval. Render the image straight into one
// bubble instead.
